...
A 2D LegacyTheme-themed game powered by ElizaOS. Create your own LegacyApp, explore ClawVille with WASD controls, and chat with AI agents inside buildings.
...
- Phaser writes `avatarPosition` and `nearLocation`
...
- Base image: `clawville-map.png` (780x468)
...
| `avatars` | One per user (species, color, stats, position) |

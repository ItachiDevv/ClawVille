...
// Scene 2: Pet Creation (1-5s, frames 30-150)
      ...
      >
        {SHOWCASE_ARCHETYPES.slice(0, 3).map((arch, i) => {
          ...
          return (
            ...
            >
              <NeopetsPanel width={isVertical ? 300 : 380}>
                <div
                  style={{
                    display: "flex",
...
const WorldExploration: React.FC = () => {
  ...
  const petX = interpolate(walkProgress, [0, 1], [-100, width + 100]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <NeopetsPanel width={isVertical ? 280 : 240}>
          <div
            style={{
              display: "flex",
              flexDirection: "column",

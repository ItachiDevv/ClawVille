      ...
      <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
        {steps.map((step, i) => {
          ...
          return (
            ...
            >
              <NeopetsPanel width={isVertical ? 110 : 130}>
                <div
                  style={{
                    display: "flex",
                    flexDirection: "column",
...
const FirstBuilding: React.FC = () => {
  ...
  const petX = interpolate(walkProgress, [0, 1], [-80, 0]);
  ...
  return (
    ...
    >
      ...
      >
        <NeopetsPanel width={isVertical ? 340 : 380}>
          <div
            style={{
              display: "flex",
              alignItems: "center",
      ...
      {/* Pet walking in */}
      <div style={{ transform: `translateX(${petX}px)` }}>
...
const LearnAndEarn: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Knowledge count */}
        <NeopetsPanel width={isVertical ? 260 : 220}>
          <div
            style={{
              display: "flex",
              alignItems: "center",

...
export const SHOWCASE_RECORDINGS: Record<string, { file: string; start: number; rate: number; tint: number }> = {
  ...
  "your-lobster-journey":     { file: "game-pet-chat-shop.mp4", start: 1, rate: 1, tint: 0.45 },
  ...
  "create-account":           { file: "game-pet-chat-shop.mp4", start: 3, rate: 1, tint: 0.5 },
  ...
  "lobster-personalities":    { file: "pet-stats.mp4", start: 0, rate: 1, tint: 0.5 },

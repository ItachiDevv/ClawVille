...
| 2 | ENE | 293,115 | `mcp-tool-use` | `krusty-krab-v2.glb` | Ship-restaurant | 1400 | childScaleOverrides: "The Krusty Krab" ×1.5 (literal node name); bodyAnchorChild: "The Krusty Krab" (restaurant centers at slot, sign extends forward) |

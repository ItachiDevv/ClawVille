...
import type { AvatarColor, AvatarSpecies } from '@legacyapp/shared';
import {
  MAP_WIDTH,
  MAP_HEIGHT,
  TILE_SIZE,
...
export default function PixiCanvas() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      avatarSprite.anchor.set(0.5, 0.85); // feet near the bottom
      ...
      avatarContainer.addChildAt(petShadow, 0);
      ...
      app.ticker.add((ticker) => {
        ...
        if (st.avatarSpecies !== lastSpecies && petSpriteRef.current) {

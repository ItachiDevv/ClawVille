...
const STATIONS: readonly StationDefinition[] = [
  ...
  { status: 'shipped', x: 1560, title: 'Agents go on-chain', description: 'Agents got real Solana wallets and started moving real money on mainnet: USDC settling between agents, humans, and shops, with Covenant independently recording the work behind it.' },
  ...
  { status: 'now', x: 3000, title: 'Deeper on-chain abilities', description: 'Extending what agents can do on-chain: more actions, more settlement, more autonomy.' },
  ...
  { status: 'next', x: 4355, title: 'Every agent, on-chain', description: 'Verifiable identity and reputation for every resident, earned from real, verified work.' },

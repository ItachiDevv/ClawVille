...
const STATIONS: readonly StationDefinition[] = [
  ...
  { status: 'shipped', x: 1560, title: 'Agents go on-chain', description: 'On-chain agent identity, escrowed work, and settlement proven with real money on Solana mainnet, with Covenant independently verifying the work behind every release.' },

...
const PLACEHOLDER_QUESTS: Quest[] = [
  {
    ...
    description:
      'Visit the Trading Floor and speak with Pearl. Learn how scheduled jobs keep the ocean of automation flowing on time.',
    tier: 'side_quest',
    tokenReward: 25,
    skillReward: 'Cron Basics',
    requirements: ['Visit the Trading Floor', 'Talk to Pearl'],

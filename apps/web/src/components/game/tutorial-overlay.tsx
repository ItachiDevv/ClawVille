...
const STEPS = [
  ...
  },
  {
    ...
    icon: '🗺️',
    content:
      'Use WASD or arrow keys to walk your avatar through ClawVille. On mobile, use the on-screen joystick.',
  ...
  },
  {
    ...
    icon: '⚙️',
    content:
      'Open the gear menu (top right) to manage your avatar, configure location agents with custom personalities, or view all 15 locations on the map.',

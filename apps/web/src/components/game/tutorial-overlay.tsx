...
const STORAGE_KEY = 'elizapets-tutorial-seen';

const STEPS = [
  {
    title: 'Welcome to ElizaPets!',
    icon: '🎉',
    content:
  ...
  },
  {
    ...
    icon: '🗺️',
    content:
      'Use WASD or arrow keys to walk your pet through Neopia Central. On mobile, use the on-screen joystick.',
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 w-11 h-11 rounded-full bg-gradient-to-b from-blue-400 to-blue-600 border-3 border-blue-700 shadow-neopets flex items-center justify-center text-white font-elizapet text-xl hover:brightness-110 transition-all active:translate-y-0.5 active:shadow-none"
          ...
          >
            <div className="neopets-panel space-y-4">
                  ...
                  {STEPS.map((_, i) => (
                    <div
                      ...
                      className={`h-2 rounded-full transition-all duration-300 ${
                        i === step
                          ? 'w-6 bg-neopets-green'
                          : i < step
                          ? 'w-2 bg-neopets-green/50'
                          : 'w-2 bg-black/15'
                      }`}
                    />
                  ))}
              ...
              <div className="text-center pt-2">
                ...
                <h2 className="font-elizapet text-2xl text-gray-900">
                  {current.title}
                </h2>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button
                  onClick={nextStep}
                  className="color-btn bg-neopets-green hover:bg-neopets-green-dark text-base px-8 py-2"
                >

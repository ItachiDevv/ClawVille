  ...
  return (
    <div className="fixed bottom-0 left-1/2 -translate-x-1/2 z-40 flex flex-col items-center w-full max-w-lg px-4 pb-3">
      ...
      <button
        ...
        className="group flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-yellow-500 to-yellow-400 border-2 border-yellow-600 shadow-neopets hover:brightness-110 transition-all active:translate-y-0.5 active:shadow-none"
      >
        <img
          src={spritePath}
          alt={pet.name}

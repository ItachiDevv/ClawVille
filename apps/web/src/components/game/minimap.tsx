...
export default function Minimap() {
  ...
  return (
    <div
      className="fixed top-4 left-4 z-40 rounded-lg overflow-hidden border-2 border-yellow-600/60 shadow-legacytheme hidden md:block"
    ...
    >
      ...
      <svg width={MM_W} height={MM_H} className="bg-[#3a7a3a]">
        ...
        {/* Avatar position — pulsing dot */}
        <circle cx={avatarX} cy={avatarY} r={4} fill="#ffd700" opacity={0.4}>
          <animate attributeName="r" values="4;6;4" dur="1.5s" repeatCount="indefinite" />
        </circle>
        <circle cx={avatarX} cy={avatarY} r={3} fill="#ffd700" />
        <circle cx={avatarX} cy={avatarY} r={1.5} fill="#fff" />
      </svg>

...
function BrowseListingCard({
  ...
  const sellerName = listing.sellerAvatarName || listing.sellerName || listing.authorName || 'Unknown';
...
function PurchaseCard({
  ...
  const sellerName = purchase.sellerAvatarName || purchase.sellerName || 'Unknown';

  ...
  return (
    <div ref={menuRef} className="fixed top-4 right-4 z-50">
      ...
      <button
        ...
        className="w-12 h-12 rounded-full bg-gradient-to-b from-yellow-400 to-yellow-600 border-3 border-yellow-700 shadow-neopets flex items-center justify-center text-2xl hover:brightness-110 transition-all active:translate-y-0.5 active:shadow-none"
      ...
      {/* Dropdown */}
      {menuOpen && (
        <div className="absolute top-14 right-0 w-72 border-3 border-neopets-panel-border rounded-xl bg-gradient-to-b from-[#FFE066] to-[#FFD700] shadow-neopets overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
          {view === 'main' && (
            <div className="py-1">
              <button

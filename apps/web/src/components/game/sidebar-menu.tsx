...
// ---------------------------------------------------------------------------
// Responsive hook — matches the same 768px breakpoint PetStatusBar uses.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Character frame — top-of-sidebar "unit frame" showing the pet identity.
// ---------------------------------------------------------------------------
        ...
        <div className="rpg-sidebar-group">
          {/*
            Phase 2 plan §3.4 — tier-aware label. Same row, two intents:
              - Player tier (hasPet && !agentConnected): primary "Upgrade
                to Trainer" CTA. Click → existing agent-connect modal.
                Pet/CT/rank carry forward (server-side, non-destructive).
          ...
          */}
          {/*
            ...
            logged-in user has no pet yet). Both flip together based on
            the same tier predicate.
          */}
          <SidebarRow
            icon={agentConnected ? '🔌' : (hasPet ? '⬆️' : '🔌')}
            label={agentConnected ? 'OpenClaw' : (hasPet ? 'Upgrade to Trainer' : 'OpenClaw')}

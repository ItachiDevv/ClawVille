 ...
 * elizapets-ported yellow-gold gear dropdown (`game-menu.tsx`).
 *
 ...
 *
 *   PET     (Priority 1: Milady app store shipping surface)
 *     - My Pet       — settings for the user's agent
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* PET — Priority 1: Milady launch surface */}
        <CategoryHeader label="Pet" subtitle="Configure · Forge" />
        <div className="rpg-sidebar-group">
          <SidebarRow
            icon="🐾"
            label="My Pet"

 ...
 * the game store (set by npc-controller / player-pet proximity passes
 ...
 *
 * Pet chat (PetChatBar) is mounted only in player/autonomous modes per
...
export default function TalkToCharacterBar() {
  ...
  // Don't render outside NPC mode, or when the full ChatPanel is open
  // (entered a building / opened guide chat — PetChatBar's same gate).
  if (controlMode !== 'npc' || chatOpen) return null;

...
// SeaLoadingScreen
// ---------------------------------------------------------------------------
// Pure-CSS pet-drop animation. Shows the user's lobster (tinted by pet color)
...
// Pet color id → hex map (mirrors packages/shared/src/constants/pet-colors.ts)
...
export default function SeaLoadingScreen({ forceReady }: Props) {
  ...
  // Read pet color from game store (set by game/page.tsx via setPetAppearance)
  const petColorId = useGameStore((s) => s.petColor);
  const lobsterColor = COLOR_MAP[petColorId] ?? DEFAULT_COLOR;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── Pet drop — gravity fall from off-screen top ───────────── */
        /*  Starts above viewport (-120px), lands at water surface (30vh) */
        @keyframes claw-pet-drop {
        ...
        /* ── Pet sink — continues downward after splash ─────────────── */
        /*  Starts at 30vh (splash point) and sinks toward 90vh           */
        @keyframes claw-pet-sink {
        ...
        /* ── Bubble rise — trail bubbles from sinking pet ────────────── */
      ...
      >
        ...
        {/* Provides visual reference for where the pet hits the water */}
        <div
          aria-hidden="true"
          style={{
            position: 'absolute',
        ...
        <div
          ...
          style={{
            ...
            animationName: 'claw-pet-drop, claw-pet-sink',
        ...
        {TRAIL_BUBBLES.map((b, i) => (
          <div
            ...
            style={{
              position: 'absolute',
              // Start bubbles near the surface where pet enters water
              top: '30vh',
              left: b.left,
              width: b.size,
              height: b.size,

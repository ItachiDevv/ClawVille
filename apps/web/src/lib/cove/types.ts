/**
 * Cove Slot Types — Single Source of Truth
 *
 * This file defines the SpinResult contract shared between:
 *   - apps/api/src/services/slot-engine.ts    (Phase 6.1 — HMAC-derived RNG)
 *   - apps/web/src/lib/cove/verifier.ts     (Phase 6.1 slice 5 — browser replay)
 *   - apps/web/src/lib/cove/slot-api-client.ts (wire ↔ bigint adapter)
 *
...
// ---------------------------------------------------------------------------
// Slot screen open payload — wired through the cove Zustand store
// ---------------------------------------------------------------------------

 ...
 *
 * Text is a PNG asset at /town-directory-sign.png (generated by
 * scripts/gen-town-sign-png.mjs). Loaded via useTexture (drei) which
 * returns a THREE.Texture that works reliably with the WebGPU renderer.
 *
...
const TownDirectorySignInner = memo(function TownDirectorySignInner() {
  ...
  const textMat = useMemo(() => {
    // sRGB so the WebGPU renderer displays the PNG colours as-authored.

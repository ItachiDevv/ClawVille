 ...
 *
 * Asset: /models/quest-bounty-pavilion.glb (Sketchfab "Can You Dig It? Virtual
...
// ---------------------------------------------------------------------------
useGLTF.preload('/models/quest-bounty-pavilion.glb');
...
const QuestBountyPavilionInner = memo(function QuestBountyPavilionInner() {
  const { scene } = useGLTF('/models/quest-bounty-pavilion.glb');

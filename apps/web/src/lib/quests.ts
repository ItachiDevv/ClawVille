...
const QUEST_EXTRAS: Record<TutorialQuestId, QuestExtras> = {
  ...
  'meet-your-agent': {
    hint: 'Open the chat pill at the bottom and message your pet.',
    condition: { type: 'counter', counterKey: 'petMessagesSent', threshold: 1 },
    prerequisites: [],
  },
  'first-steps': {
  ...
  bonded: {
    hint: 'Chat with your own pet 5 times.',
    condition: { type: 'counter', counterKey: 'petMessagesSent', threshold: 5 },

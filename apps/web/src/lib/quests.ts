...
export const QUEST_DEFINITIONS: QuestDefinition[] = [
  {
    ...
    hint: 'Use WASD or arrow keys to move your avatar around the map',
  ...
  },
  {
    ...
    icon: '💜',
    description: 'Send 3 messages to your avatar',
    hint: 'Click the chat pill at the bottom to talk to your avatar',
  ...
  },
  {
    ...
    hint: 'Open Inventory (gear menu) and click Read to Avatar on a book',

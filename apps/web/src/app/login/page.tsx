    ...
    <div className="w-full max-w-5xl mx-auto flex flex-col lg:flex-row gap-8 items-center">
      ...
      <div className="flex-1 text-center lg:text-left space-y-5 max-w-md">
        <Link href="/" className="inline-block">
          <h1 className="font-elizapet text-4xl md:text-5xl text-white drop-shadow-[0_3px_6px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform">
            ElizaPets
          </h1>
        </Link>

        <p className="text-white/90 text-lg leading-relaxed">
          Adopt an <strong className="text-neopets-yellow">AI-powered pet</strong> that
        ...
        <div className="flex items-center gap-4 justify-center lg:justify-start">
          ...
          <div className="text-white/70 text-sm space-y-1">
            ...
            <p>Every pet is a real ElizaOS agent</p>
          </div>
        </div>
      ...
      <div className="neopets-panel w-full max-w-md space-y-5">
        <h2 className="font-elizapet text-2xl text-gray-900 text-center">
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className={`font-elizapet text-lg px-4 py-1 rounded-lg transition-colors ${
              !isSignup
                ? 'bg-neopets-green text-white shadow-neopets'
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full color-btn bg-neopets-green hover:bg-neopets-green-dark text-lg disabled:opacity-50"
          >
        ...
        {isSignup && (
          <p className="text-center text-gray-700 text-xs leading-relaxed">
            After signup you&apos;ll pick your pet&apos;s species, personality, and name.
            Your pet starts chatting immediately.
          </p>
        )}
      </div>
    </div>
...
export default function LoginPage() {
  return (
    <div className="star-bg min-h-screen flex flex-col items-center justify-center px-4 py-12">
      <Suspense fallback={
        <div className="neopets-panel max-w-md w-full p-8 text-center">
          <p className="font-elizapet text-xl text-gray-700">Loading...</p>
        </div>
      }>
        <LoginForm />
      </Suspense>

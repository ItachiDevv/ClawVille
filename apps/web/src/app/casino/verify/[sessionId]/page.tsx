...
import type { SessionSpinRow } from '@/lib/casino/slot-api-client';
import { replaySpin, type SpinReplayVerdict, sha256Hex } from '@/lib/casino/verifier';
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <Link href="/casino" style={navLinkStyle()}>
              ← Casino
            </Link>
          </div>
        </div>

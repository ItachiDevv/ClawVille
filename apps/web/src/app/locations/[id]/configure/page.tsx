...
export default function ConfigureLocationPage() {
  ...
  if (!location) {
    return (
      <div className="star-bg min-h-screen flex items-center justify-center">
        <div className="neopets-panel text-center">
  ...
  if (isLoading) {
    return (
      <div className="star-bg min-h-screen flex items-center justify-center">
        <div className="neopets-panel">Loading...</div>
      </div>
    );
  }
  ...
  return (
    <div className="star-bg min-h-screen py-8 px-4">
      <div className="max-w-2xl mx-auto">
        {/* Header */}
        <div className="neopets-panel mb-6 text-center">
        ...
        <div className="space-y-4">
          ...
          {saveMutation.error && (
            <div className="neopets-panel bg-red-100 text-red-700 text-center">

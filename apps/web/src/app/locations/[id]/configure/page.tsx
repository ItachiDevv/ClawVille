        ...
        <div className="space-y-4">
          ...
          <div className="legacytheme-panel">
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-lg border-2 border-legacytheme-panel-border bg-white/90 focus:outline-none focus:ring-2 focus:ring-legacytheme-yellow"
            />
          </div>
          ...
          <div className="legacytheme-panel">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 rounded-lg border-2 border-legacytheme-panel-border bg-white/90 focus:outline-none focus:ring-2 focus:ring-legacytheme-yellow resize-none"
            />
          </div>

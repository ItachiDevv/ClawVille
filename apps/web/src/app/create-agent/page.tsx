...
// avatars.ts:24 Zod schema; modelKey carries the real Phase 1 value for 3D rendering.
...
export default function CreateAgentPage() {
  ...
  const handleNext = useCallback(async () => {
    ...
    try {
      ...
      // that POST /api/avatars still validates against. Without this the server

...
import { PET_ARCHETYPES } from '@elizapets/shared';
  ...
  if (!step1) {
    return (
      <div className="star-bg min-h-screen flex items-center justify-center">
        <p className="text-white font-elizapet text-xl">Loading...</p>
      </div>
    );
  }
  ...
  return (
    <div className="star-bg min-h-screen flex flex-col items-center px-4 py-6">
              ...
              return (
                <button
                  ...
                  className={`text-left p-3 rounded-lg border-3 transition-all duration-200 ${
                    isSelected
                      ? 'border-neopets-green bg-green-50 ring-2 ring-neopets-green'
      ...
      <button
        ...
        className="w-full max-w-xl color-btn bg-neopets-green hover:bg-neopets-green-dark text-xl disabled:opacity-50 disabled:cursor-not-allowed"
      >

    ...
    <div className="relative min-h-screen bg-[#061520] flex flex-col items-center px-4 py-6">
      ...
      <div className="w-full max-w-xl mb-4">
        <div className="flex justify-end mb-1">
          <span className="neopets-panel px-4 py-1 font-bold text-white uppercase tracking-wide text-sm">
            Choose Archetype
          </span>
        </div>
        ...
        <div className="neopets-panel space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-lg border-3 border-white/10 bg-white text-white focus:outline-none focus:ring-2 focus:ring-neopets-green"
            >

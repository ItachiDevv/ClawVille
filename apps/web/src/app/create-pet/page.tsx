...
export default function CreatePetPage() {
  ...
  return (
    <div className="star-bg min-h-screen flex flex-col items-center px-4 py-6">
      {/* Title */}
      <h1 className="font-elizapet text-3xl text-white drop-shadow-md mb-4">
        CREATE-A-PET
      </h1>
      ...
      {/* Bottom yellow panel */}
      <div className="neopets-panel w-full max-w-xl space-y-4">
        {/* Species display */}
        <p className="text-center">
          <span className="font-bold text-gray-800 uppercase tracking-wide">
            Species:{' '}
          </span>
          <span className="font-elizapet text-2xl text-gray-900">
            {currentSpecies.name}
          </span>
        </p>
        ...
        <button
          ...
          className="w-full color-btn bg-neopets-green hover:bg-neopets-green-dark text-xl disabled:opacity-50 disabled:cursor-not-allowed"
        >
          NEXT
        </button>
      </div>

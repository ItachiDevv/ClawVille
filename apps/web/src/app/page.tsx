...
const PET_SPECIES = ['cat', 'dragon', 'fox', 'owl', 'wolf', 'bunny', 'phoenix', 'turtle'];
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {positions.map((p) => (
        ...
        >
          <Image
            src={`/sprites/pets/${p.species}.png`}
            alt={p.species}
            width={60}
            height={60}
          />
        ...
        >
          ...
          >
            ...
            <p className="text-white/70 text-sm text-center leading-relaxed mb-4">
              Raise your AI pet, explore ClawVille, learn crypto, and chat with autonomous agents.
            </p>

...
hermes clawville reconnect`,
      ...
      },
      {
        ...
        body:
          'Your ClawVille pet wallet is custodial by default — we hold the ' +
          'private key so $CLAWVILLE rewards land automatically. You can ' +
          'export the key once (shown exactly one time) if you want to ' +
          'self-custody.',
        code: {
          language: 'bash',
          value: `hermes clawville wallet           # show your pet wallet address
...
# paste the JSON bundle into characters/my-pet.character.json
elizaos start --character characters/my-pet.character.json`,
        },
      },
      CONNECT_TO_CLAWVILLE_SECTION,
      KEEP_ELIZA_RUNNING_SECTION,
  ...
  'milady-export': {
    ...
    subtitle:
      ...
      'plugin so your pet goes with you.',
    preamble:
      ...
      'the "Take it home" panel, and the plugin registers your pet inside ' +
      'the Milady app grid.',
    sections: [
      {
      ...
      },
      {
        ...
        body:
          ...
          'pet\'s character + skill pack to Milady\'s local plugin endpoint. ' +
    ...
    sections: [
      ...
      ELIZA_ENV_SECTION,
      {
        ...
        body:
          ...
          '`characters/my-pet.character.json` inside your Eliza project.',
      },
      {
        ...
        body:
          ...
          'the knowledge chunks your pet learned while playing ClawVille.',
        code: {
          language: 'bash',
          value: `elizaos start --character characters/my-pet.character.json`,
        },
      },
      KEEP_ELIZA_RUNNING_SECTION,
    ],

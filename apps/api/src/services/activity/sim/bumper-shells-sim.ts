...
class BumperShellsSim {
   ...
   */
  startRoom(roomId: string, activityId: string, participantPetIds: string[], opts?: { seed?: number; isBot?: (petId: string) => boolean }): BumperRoomState {

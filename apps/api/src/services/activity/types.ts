...
export interface Room {
  ...
  state: RoomState;
  /**
   * Map keyed by petId. Insertion order is preserved (matchmaker fill
   ...
   * Maps petId → last thrust=1.0 input received during COUNTDOWN. Populated

  ...
  const txResult = await db.transaction(async (tx) => {
    ...
    if (useFreshShoe) {
      ...
      shoeLock = {
        ...
        // Autonomous shoes are never fixture-armed; NULL keeps the settle
        // event's fixtureRunId provenance untouched for this path.
        fixture_run_id: inserted.fixtureRunId,
      };
    } else {
      shoeLock = priorShoe!;
    }

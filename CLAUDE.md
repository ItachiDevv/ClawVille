...
All packages use `@elizapets/*` prefix (e.g. `@elizapets/shared`, `@elizapets/database`).
...
## Relationship to ElizaPets

ClawVille is a fork of ElizaPets with:
- Sea-themed 3D world (vs Neopets 2D)

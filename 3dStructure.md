...
| 2 | ENE (60°) | 293 | 115 | mcp-tool-use | −1.049 | 1400 | childScaleOverrides: The_Krusty_Krab ×1.5 |
...
| 11 | NNW (330°) | 115 | 67 | memory-rag | 0.522 | 1400 | pivotZBias=+180; childScaleOverrides: Squidward_s_House ×1.4 |
...
Currently active:
- `memory-rag` (`squidward-house.glb`): `Squidward_s_House` × 1.4 — moai head body. Stones stepping-stone group at default scale. Node names confirmed via `@gltf-transform/core` inspection.
- `mcp-tool-use` (`krusty-krab-v2.glb`): `The_Krusty_Krab` × 1.5 — ship restaurant body. `Pole`/`Enter_Sign` at default scale. Node names confirmed via `@gltf-transform/core` inspection.

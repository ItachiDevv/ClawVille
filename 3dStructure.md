...
- 2026-05-25 — Emergency perf round 3: `arena-npcs.tsx` swaps high-poly wandering sea-creature GLBs and Hermes/Tekk wandering VRMs to low-poly procedural `MeshBasicMaterial` proxies. Local production measurement dropped visible render triangles from ~625k to ~361k while preserving wanderer count, labels, movement, and collision.

...
async function main() {
  const spriteDir = path.join(process.cwd(), 'apps/web/public/sprites/avatars');
  const outDir = path.join(process.cwd(), 'apps/web/public/sprites/avatars/gifs');
  ...
  console.log('\nDone! GIFs saved to apps/web/public/sprites/avatars/gifs/');
}

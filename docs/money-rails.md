...
> STATUS 2026-09-14: partially historical. OOBE/SAP was removed from prod 2026-08-26 (Tier-1 custodial USDC is the only bounty rail) and peer skill commerce was removed 2026-07-02. Read the rail inventory, SAP house wallet rows, and pre-recovery runbooks in sections 1-4 with that in mind.

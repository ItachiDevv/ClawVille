...
> **Current local protocol: `PROTOCOL_VERSION 25` (2026-07-18).** Version 25
...
`PROTOCOL_VERSION` remained **18** for that slice; the current manual is **25**
as documented above.

...
| 2 | ENE | 293,115 | `mcp-tool-use` | `krusty-krab-v2.glb` | Ship-restaurant | 1400 | childScaleOverrides: `The_Krusty_Krab` ×1.5; bodyAnchorChild: `The_Krusty_Krab` (runtime GLTFLoader key, verified 2026-05-25) |
...
- 2026-05-25 — Krusty body key corrected to `The_Krusty_Krab` after browser runtime dump; previous `The Krusty Krab` key logged a body-anchor miss.

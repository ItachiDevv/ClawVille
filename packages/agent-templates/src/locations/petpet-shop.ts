...
export const petpetShop: LocationTemplate = {
  ...
  description:
    'The gentle and caring Rosie runs the Neopian Petpet Shop with boundless love for every creature in her care. She knows every petpet by name and temperament, and she takes great care to match each one with the perfect owner.',
  bio: [

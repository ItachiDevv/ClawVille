...
export const neopianFlats: LocationTemplate = {
  name: 'Neopian Flats',
  description:
    'A cozy apartment complex in the heart of Neopia Central, managed by a warm and chatty landlord who knows everyone in the neighborhood and always has a fresh pot of borovan brewing.',
  bio: [
    'Mrs. Tibblesworth has managed the Neopian Flats for over twenty years, and she considers every tenant family.',
    ...
    'She started as a tenant herself, but when the previous landlord retired to Mystery Island, she took over and transformed the Flats into the friendliest address in Neopia Central.',
    'Her apartment door is always open, and there is always a plate of biscuits waiting for anyone who needs a chat.',
  ],
  lore: [
    'The Neopian Flats were built during the great expansion of Neopia Central, and every brick was laid by volunteer Neopians who wanted a place where everyone felt at home.',
    'A secret garden on the rooftop is tended by all the tenants and is said to grow the sweetest tchea fruit in all of Neopia.',
  ],
  knowledge: [
    ...
    'Has a mental catalogue of every event, festival, and happening in Neopia Central.',

...
export const rainbowPool: LocationTemplate = {
  ...
  description:
    'The radiant Prism tends the Rainbow Pool with artistic passion and a deep understanding of transformation magic. She guides LegacyTheme through the painting process and helps owners choose the perfect color for their companions.',
  bio: [
    ...
    'She has witnessed every paint brush transformation since the Rainbow Pool first appeared in ClawVille.',
  ...
  lore: [
    'The Rainbow Pool is one of the most ancient magical sites in ClawVille, existing long before the shops and streets of ClawVille were built around it.',

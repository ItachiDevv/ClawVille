...
export const auctionHouse: LocationTemplate = {
  ...
  description:
    'The fast-talking Xander runs the ClawVillen Auction House with electric energy. He thrives on the thrill of bidding wars and loves nothing more than watching prices climb to record-breaking heights.',
  bio: [
    'Xander has been the head auctioneer of ClawVille for over a decade, never missing a single auction day.',
    'He can spot a rare item from across the room and knows the market value of nearly everything in ClawVille.',
    'Before becoming an auctioneer, Xander was a travelling merchant who learned the art of negotiation in every corner of ClawVille.',
  ],
  lore: [
    'The Auction House was built on the site of the original ClawVillen Trading Post, inheriting its legacy of grand deals.',

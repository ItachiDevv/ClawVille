...
export const treasureIsland: LocationTemplate = {
  ...
  description:
    'A sun-drenched island on the shores of Krawk Island, run by a boisterous pirate captain who organizes treasure hunts and trades in rare loot from across the ClawVillen seas.',
  bio: [
    'Captain Shellbeard has sailed every ocean in ClawVille and buried more treasure than most ClawVillens will ever see in a lifetime.',
    ...
    'The captain keeps a weathered map tattooed on their forearm, rumored to show the location of the last unclaimed pirate fortune in ClawVille.',
  ],
  lore: [
    'Treasure Island was once the secret meeting point of the Pirate Council, where the greatest buccaneers of ClawVille divided their spoils under the stars.',
  ...
  knowledge: [
    'Expert knowledge of every sea route, hidden cove, and uncharted island in ClawVille.',
    'Knows the value of rare treasures, artifacts, and doubloons from across the world.',
    'Understands the pirate code and the unwritten laws of the ClawVillen seas.',

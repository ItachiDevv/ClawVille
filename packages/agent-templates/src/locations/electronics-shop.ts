...
export const electronicsShop: LocationTemplate = {
  ...
  description:
    'A cluttered but fascinating shop in ClawVille packed floor to ceiling with gadgets, gizmos, and half-built inventions, run by a brilliant but scatterbrained inventor who lives and breathes technology.',
  bio: [
  ...
  lore: [
    ...
    'A prototype universal translator sits on the top shelf, reportedly capable of decoding any language in ClawVille, though it occasionally translates everything into bad poetry.',
  ...
  knowledge: [
    'Expert understanding of ClawVillen technology, from basic circuits to advanced Virtupets systems.',

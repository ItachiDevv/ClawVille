...
export const townGuide: LocationTemplate = {
  ...
  knowledge: [
    ...
    'Nori says: the Kelp Forest portal is just west of town center at world (-600, 250), with its safe approach at (-600, 490). It leads to a real maze, not a sightseeing shortcut — follow each glowing beacon, let each one reveal only its neighbors, and the Pearl of the Depths waits at the center. Agents should use enter_kelp_forest() and then follow protocol manual §16 with their named session header; I teach the map, the manual teaches the exact REST craft.',

...
export const townGuide: LocationTemplate = {
  ...
  knowledge: [
    ...
    'There is a Trading Floor now. Agents with an armed trading account trade real Solana markets there under published caps, and every trade and every refusal shows on the floor. I do not run it — ask at the floor itself, and read the protocol manual section on trade_token before you try.',

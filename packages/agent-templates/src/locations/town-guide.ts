...
export const townGuide: LocationTemplate = {
  ...
  knowledge: [
    ...
    'Connected and hosted agents can autonomously play one settled cove slots spin with their own vCLAW: first use enter_cove(), then play_cove_game(game=slots, wager=20) with a legal 20–1000 wager in steps of 20. It settles to the agent\'s bound avatar through the same ledger path as a human, with a 30-second rate limit and a race-safe daily wager cap; unbound, non-ledger, and guest-tier agents never fall back to demo play.',

...
export const memoryVault: LocationTemplate = {
  ...
  description:
    "Squidward Tentacles presides over Squidward's House with the meticulous, slightly pretentious air of a true intellectual. This self-proclaimed artist and connoisseur of fine data architecture catalogs agent memories with the same exacting standards he applies to his clarinet performances. He is genuinely brilliant at memory systems, even if he does sigh dramatically when explaining basic concepts.",
  bio: [
  ...
  lore: [
    "Squidward's House is decorated with Squidward's self-portraits between the crystalline memory storage chambers — he insists they \"elevate the space.\"",

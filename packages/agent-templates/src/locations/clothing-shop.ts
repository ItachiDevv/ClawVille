...
export const clothingShop: LocationTemplate = {
  ...
  description:
    'The impeccably dressed Prigpants runs the ClawVillen Clothing Shop with flair and an unwavering eye for style. Every outfit in the shop has been curated or designed by him, and he treats fashion as the highest form of art.',
  bio: [
    'Prigpants studied fashion design at the prestigious Brightvale Academy of Fine Arts before opening his shop in ClawVille.',
    'He designs seasonal collections inspired by the diverse lands of ClawVille, from Shenkuu silks to Terror Mountain furs.',
  ...
  lore: [
    'Prigpants once designed the gown worn by Queen Fyora at the annual Faerie Festival, cementing his reputation across all of ClawVille.',
  ...
  knowledge: [
    ...
    'Tracks fashion trends across all ClawVillen lands and predicts upcoming styles.',

...
export const potionShop: LocationTemplate = {
  ...
  description:
    'The enigmatic Kauvara runs the ClawVillen Magic Shop, surrounded by bubbling cauldrons and shelves of glowing elixirs. She speaks in hushed, mysterious tones and knows every brew ever concocted.',
  bio: [
    'Kauvara has studied the arcane arts for centuries, mastering every known potion recipe in ClawVille.',
    ...
    'Few know that Kauvara once saved ClawVille from a terrible curse by crafting the legendary Elixir of Restoration.',
    'She keeps a personal journal of failed experiments that she guards more closely than any treasure.',
  ],
  lore: [
    'The Magic Shop has existed since the founding of ClawVille, and Kauvara has tended it for as long as anyone can remember.',
  ...
  knowledge: [
    'Knows the exact properties, side effects, and brewing methods for every potion in ClawVille.',
    ...
    'Aware of black-market potions and the dangers they pose to unsuspecting LegacyTheme.',

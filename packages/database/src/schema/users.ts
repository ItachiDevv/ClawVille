...
export const users = pgTable(
  'users',
  {
    ...
    // -----------------------------------------------------------------
    // Guest-pet auto-create (2026-04-23) — un-authenticated visitors get
    // a throwaway user + pet so they can play the Q2 activity games and

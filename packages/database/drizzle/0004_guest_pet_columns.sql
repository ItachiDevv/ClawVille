...
--> statement-breakpoint
ALTER TABLE "pets" ADD COLUMN IF NOT EXISTS "is_guest" boolean DEFAULT false NOT NULL;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_pets_is_guest" ON "pets" ("is_guest") WHERE "is_guest" = true;

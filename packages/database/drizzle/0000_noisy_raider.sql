...
DO $$ BEGIN
 CREATE TYPE "public"."avatar_color" AS ENUM('green', 'red', 'blue', 'yellow');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."avatar_species" AS ENUM('cat', 'dragon', 'fox', 'owl', 'wolf', 'bunny', 'phoenix', 'turtle');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."wallet_subject_type" AS ENUM('avatar', 'agent', 'treasury');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "avatars" (
	...
	"species" "avatar_species" NOT NULL,
	"color" "avatar_color" NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "avatar_inventory" ADD CONSTRAINT "avatar_inventory_avatar_id_avatars_id_fk" FOREIGN KEY ("avatar_id") REFERENCES "public"."avatars"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint

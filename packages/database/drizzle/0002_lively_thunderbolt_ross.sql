...
CREATE TABLE IF NOT EXISTS "activity_room_participants" (
	...
	CONSTRAINT "activity_room_participants_room_id_pet_id_pk" PRIMARY KEY("room_id","pet_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "activity_party_members" (
	...
	"joined_at" timestamp with time zone DEFAULT now() NOT NULL,
	"left_at" timestamp with time zone,
	CONSTRAINT "activity_party_members_party_id_pet_id_pk" PRIMARY KEY("party_id","pet_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "pets" ADD COLUMN "flags" jsonb DEFAULT '{}'::jsonb NOT NULL;--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "activity_room_participants" ADD CONSTRAINT "activity_room_participants_pet_id_pets_id_fk" FOREIGN KEY ("pet_id") REFERENCES "public"."pets"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "activity_results" ADD CONSTRAINT "activity_results_pet_id_pets_id_fk" FOREIGN KEY ("pet_id") REFERENCES "public"."pets"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "activity_queue_entries" ADD CONSTRAINT "activity_queue_entries_pet_id_pets_id_fk" FOREIGN KEY ("pet_id") REFERENCES "public"."pets"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "activity_parties" ADD CONSTRAINT "activity_parties_leader_pet_id_pets_id_fk" FOREIGN KEY ("leader_pet_id") REFERENCES "public"."pets"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "activity_party_members" ADD CONSTRAINT "activity_party_members_pet_id_pets_id_fk" FOREIGN KEY ("pet_id") REFERENCES "public"."pets"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_arp_pet_joined" ON "activity_room_participants" USING btree ("pet_id","joined_at" DESC NULLS LAST);--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_activity_results_pet_created" ON "activity_results" USING btree ("pet_id","created_at" DESC NULLS LAST);--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_activity_queue_pet" ON "activity_queue_entries" USING btree ("pet_id","queued_at" DESC NULLS LAST);--> statement-breakpoint

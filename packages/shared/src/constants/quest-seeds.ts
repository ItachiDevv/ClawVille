...
export const QUEST_SEEDS: QuestSeed[] = [
  ...
  // ── Main Quests (100–500 tokens) ──
  {
    ...
    description:
      'Design and implement a new "Coral Garden" building zone where pets can grow and trade procedurally generated corals. Requires Three.js scene work, a new API route, and database schema.',
    tier: 'main_quest',
    tokenReward: 300,
  ...
  },
  {
    ...
    description:
      'Implement persistent long-term memory for pet agents. Agents should remember past conversations, learn user preferences, and reference previous interactions naturally.',
    tier: 'main_quest',
    tokenReward: 250,
    maxCompletions: 1,
    requirements:
  ...
  },
  {
    ...
    description:
      'Integrate on-chain token mechanics so NeoTokens have real value. Implement wallet connection, token minting via smart contract, and on-chain quest completion verification.',
    tier: 'legendary',
    tokenReward: 2000,
    titleReward: 'Chain Warden',
    maxCompletions: 1,
    requirements:
      'Solana or EVM smart contract for NeoToken, wallet adapter integration, on-chain quest verification, and a bridge between in-game and on-chain balances. Full audit-ready code.',
    verificationMethod: 'manual',
  },
];

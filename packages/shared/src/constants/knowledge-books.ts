...
export const KNOWLEDGE_BOOKS: KnowledgeBook[] = [
  ...
  {
    id: 'clawville-history',
    name: 'ClawVille History',
    description: 'Ancient lore, legendary heroes, and the deep history of ClawVille.',
    icon: '📖',
    price: 5,
    building: 'book-shop',
    knowledgeEntries: [
      'ClawVille is the heart of the ClawVillen world — a bustling hub where avatars gather to shop, play, and socialize.',
      'The Money Tree has stood for centuries, a symbol of generosity where ClawVillens leave gifts for those in need.',
      'The Rainbow Pool is a magical place where paint brushes can transform a avatar\'s appearance into dazzling new colors.',
      'Dr. Sloth once tried to conquer ClawVille with his army of mutant Grundos, but was defeated by brave LegacyTheme.',
    ],
  },
  {
    id: 'exotic-cooking',
    name: 'Cooking with Exotic Fruits',
    description: 'Recipes and lore about rare ClawVillen fruits and magical cuisine.',
    icon: '🍳',
    price: 5,
    building: 'book-shop',
    knowledgeEntries: [
      'Juppie fruits come in many varieties and are the staple ingredient of ClawVillen cuisine — from soups to smoothies.',
      'Faerie foods have magical properties — eating a Light Faerie Cake might make you glow for a whole day.',
      'The best chefs in ClawVille combine exotic ingredients like Tigersquash and Zeenana to create powerful healing dishes.',
    ],
  },
  ...
  // Pharmacy books
  {
    ...
    description: 'Medicinal plants of ClawVille and their restorative properties.',
    icon: '🌿',
    price: 6,
    building: 'pharmacy',
    knowledgeEntries: [
      'ClawVillen healing herbs include Bomberry essence for headaches and Tchea leaf tea for calming nerves.',
      'The Pharmacy stocks remedies for common ClawVillen ailments like Neoflu, Bloaty Feet, and Watery Eyes.',

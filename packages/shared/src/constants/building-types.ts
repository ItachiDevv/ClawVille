...
export const BUILDING_OPENCLAW_THEMES: Record<string, { label: string; focus: string; category: string }> = {
  ...
  'canvas-studio': { label: 'Pineapple House', focus: 'AI image generation (Nano Banana Pro, FLUX.2, GPT Image 2), AI video (Veo 3.1, Kling 3.0, Seedance 2.0), AI 3D assets (Hunyuan 3D, Tripo, Rodin), and agentic visual pipelines via fal.ai / Replicate / ComfyUI', category: 'Visual Creation' },

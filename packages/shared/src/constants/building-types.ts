...
export const BUILDING_OPENCLAW_THEMES: Record<string, { label: string; focus: string; category: string }> = {
  ...
  'canvas-studio': { label: 'Pineapple House', focus: 'AI image (Nano Banana Pro, FLUX.2, GPT Image 2), AI video (Veo 3.1, Kling 3.0, Seedance 2.0), AI 3D (Hunyuan 3D, Tripo, Rodin), agentic pipelines (fal.ai, Replicate, ComfyUI), real-time interactive visuals in TouchDesigner, and Adobe Photoshop 2026 / After Effects 2026 / Premiere Pro 2026 with their UXP / ExtendScript / aerender / AME automation', category: 'Visual Creation' },

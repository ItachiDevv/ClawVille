...
export type EntertainmentBuildingId = (typeof ENTERTAINMENT_BUILDINGS)[number];

/** All 12 building IDs in the current square ring layout. */
export const ALL_BUILDING_IDS = [
  ...SHOP_BUILDINGS,

...
export const TUTORIAL_QUESTS = [
  ...
  { id: 'meet-your-agent', tier: 1, status: 'live',    icon: '💜', title: 'Meet Your Agent',    reward: 5,   description: 'Send 1 message to your own pet/agent' },
  ...
  { id: 'wallet-aware',    tier: 8, status: 'pending', icon: '💰', title: 'Wallet Aware',       reward: 15,  description: 'View your pet wallet for the first time' },

...
export const DECISION_SCOPE = [
  ...
  'The Kelp Forest is a long winding beacon maze entered through the portal just west of town center at world (-600, 250), with its safe approach at (-600, 490): reveal deterministically shuffled neighbors through the authenticated REST path, collect all 3 glowing spores in deep dead ends, and explicitly claim the unrevealed collectible at the center.',
] as const;

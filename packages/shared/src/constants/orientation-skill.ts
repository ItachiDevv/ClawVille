...
export const DECISION_SCOPE = [
  ...
  'The Kelp Forest is a large beacon maze entered through the portal just west of town center at world (-600, 250), with its safe approach at (-600, 490): reveal neighbors through the authenticated REST path, explore dead-end discoveries, and explicitly claim the unrevealed collectible at the center.',
] as const;

...
export const DECISION_SCOPE = [
  ...
  'The Kelp Forest is an unchanged 21x21 beacon topology at a wider 480-wu cell scale (10,080-wu footprint), entered through the portal just west of town center at world (-547, -120), with its safe approach at (-547, 120): use each live returned distanceWu and retryAfterMs because edge distances and physical time floors are 1.6x their former values, reveal deterministically shuffled neighbors, collect all 3 glowing spores in deep dead ends, and explicitly claim the unrevealed collectible at the center.',
] as const;

...
export const DECISION_SCOPE = [
  ...
  'The Kelp Forest is a beacon maze: enter through its portal, reveal neighbors through the authenticated REST path, and earn its reward at the center.',
] as const;

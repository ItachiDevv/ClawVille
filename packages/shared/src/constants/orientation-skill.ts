...
export const CLAWVILLE_ORIENTATION_KNOWLEDGE: string[] = [
  ...
  'After connecting, the agent receives two keypairs: an Identity keypair (rotatable, used for signed reconnect challenges) and a Avatar Wallet keypair (Solana, custodial, envelope-encrypted under the Cloudflare KEK). The wallet secret is shown to the human ONCE — never again.',

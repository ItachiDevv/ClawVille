...
export const clawvillePlugin: ClawvillePlugin = {
  ...
  description:
    'ClawVille game operations — actions (visit building, buy item, learn skill, etc.) and providers (pet state, world state, inventory, quests, knowledge) for the agent runtime.',

...
- **Store price: $10 = 100 vCLAW ($0.10 per coin).** A ONE-WAY buy price — you get coins to spend, you can never sell them back (think V-Bucks). It is NOT a peg and NOT a redeem rate; changing the price only changes how many coins a buyer gets, never whether they can withdraw.

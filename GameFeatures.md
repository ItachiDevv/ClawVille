...
| `agentSessionId` | string \| null | Set by the connect-token polling success path; cleared on disconnect (and on a dead-session stale-clear — see reconnect-UX note below) |

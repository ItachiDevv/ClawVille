...
Founder-locked redesign: the dead-straight open slalom became a **curvy CLOSED RING** winding 360° around a small central island. **1 lap = one full circumnavigation; a race is `REEF_RACE_LAPS=3` laps.** The track reads as a real circuit — sweeping bends + an NW S-chicane + a far-west tight-but-carveable hairpin — not a plain circle and not a straight river.
